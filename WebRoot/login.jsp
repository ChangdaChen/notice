...
<%
	...
	System.out.println("访问者ip地址为：" + ip);
	System.out.println("总访问次数为" + count);
%>
...
<body>
	...
	<div class="login">
		<h1>Login</h1>
		<form action="LoginSvt" method="post">
			...
			<a href="register.jsp" class="btn btn-primary btn-block btn-large"
