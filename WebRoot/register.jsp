...
<body>
	<div class="login">
		<h1>Register</h1>
		<form action="RegisterSvt?op=register" method="post">
			...
			<button type="submit" class="btn btn-primary btn-block btn-large" style="float: right;">注册</button>
			<a  href="RegisterSvt?op=logout" class="btn btn-primary btn-block btn-large" style="float: left;text-decoration: none;">返回登陆</a>
		</form>
	</div>
</body>
</html>
